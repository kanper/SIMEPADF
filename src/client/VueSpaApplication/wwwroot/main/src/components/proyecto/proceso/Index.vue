        ...
        data() {
            return {
                ...
                dataTableOptions: [
                    ...
                    {text: 'Cancelar Proyecto', type: 'link', icon: ' mdi-close-circle-outline', action: 'cancel', class: 'mr-2', route: '', show: (row) => {return (row.is3Review && row.isChecked) || row.isInProcess}},
                ],
            }
        },
        methods: {
