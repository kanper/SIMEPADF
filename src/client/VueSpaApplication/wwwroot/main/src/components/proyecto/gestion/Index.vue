        ...
        data() {
            return {
                ...
                dataTableOptions: [
                    ...
                    {text: 'Activar proyecto', type: 'link', icon: 'mdi-checkbox-marked-circle-outline', action: 'active', class: 'mr-2', route: '', show: (row) => {return (row.isIncomplete || row.isVerified) && row.isPlanTrabajo && row.isIndicador}},
