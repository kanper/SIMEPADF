            ...
            <v-card-text>
                <v-container grid-list-md>
                    <v-layout wrap>
                        <v-flex xs12>
                            <form>
                                <NewUniqueEntity identifierName="Nombre del objetivo" :identifierValue="this.newModel.nombre"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            validateIdentifier() {
                if(this.newModel.nombre !== null)
                    if(this.newModel.nombre.length > 0)
                        this.validateNewEntity({entityName:"objetivo",identifier:this.newModel.nombre});
            },
            disableSaveBtn(){
