<template>
    <div>
        ...
        <v-container>
            <v-layout>
                <v-flex>
                    <OptionPanel tracing="seguimientoRegion" :onlyYear="true" :SRI_PDF="true"/>
                    <DataTable />
                </v-flex>
            </v-layout>
        </v-container>
...
<script>
    ...
    import DataTable from './DataTableSIR'
    ...
    export default {
        ...
        name: "seguimientoIndicadoresRegion",
        data() {
            return {
                model: {
                    modelName: 'desagregado',
                    modelIcon: 'mdi-table-large',
                    modelTitle: 'Seguimiento de indicadores: Información por Región',
