            ...
            <v-card-text>
                <v-container grid-list-md>
                    <v-layout wrap>
                        <v-flex xs12>
                            <form>
                                <EditUniqueEntity identifierName="Nombre del producto" :identifierValue="this.CRUDModel.nombreProducto"/>
                                <v-text-field
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState(['modelSpecification', 'visibleEditDialog', 'CRUDModel', 'services', 'CRUDAvailable', 'isUniqueEntity'])
        },
        methods: {
            ...
            validateIdentifier() {
                if(this.CRUDModel.nombreProducto !== null)
                    if(this.CRUDModel.nombreProducto.length > 0)
                        this.validateEditEntity({entityName:"producto",id:this.CRUDModel.id,identifier:this.CRUDModel.nombreProducto});
            },
            disableSaveBtn(){
