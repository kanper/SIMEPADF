            ...
            <v-card-text>
                <v-container grid-list-md>
                    <v-layout wrap>
                        <v-flex xs12>
                            <form>
                                <NewUniqueEntity identifierName="Nombre del producto" :identifierValue="this.newModel.nombreProducto"/>
                                <v-text-field
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            validateIdentifier() {
                if(this.newModel.nombreProducto !== null)
                    if(this.newModel.nombreProducto.length > 0)
                        this.validateNewEntity({entityName:"producto",identifier:this.newModel.nombreProducto});
            },
            disableSaveBtn(){
